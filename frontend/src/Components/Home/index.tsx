          ...
          <Card elevation={3} sx={{ p: 2 }}>
            <Box sx={{ py: 1 }}>
              <Typography align='justify'>
                Vous êtes sur le point d&apos;entrer dans un monde de ténèbres
                et de mystères, où la magie règne en maître et où chaque choix
                peut mener à la gloire ou à la mort. Aube Obscure est un jeu de
                rôle qui vous plongera dans un univers fantastique rempli de
                créatures étranges et de lieux mystérieux.
              </Typography>
            </Box>
            <Box sx={{ py: 1 }}>
              <Typography align='justify'>
                En tant qu&apos;aventurier, vous explorerez des donjons sombres
                et dangereux, combattrez des ennemis redoutables, résoudrez des
                énigmes complexes et découvrirez des trésors fabuleux. Vous
                devrez faire preuve de courage, de sagesse et d&apos;habileté
